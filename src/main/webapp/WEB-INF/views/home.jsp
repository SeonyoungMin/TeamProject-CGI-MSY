...
<body>
	...
	<nav class="category-bar">
		<a href="${ctx}/productList">전체</a>
		<a href="${ctx}/product/category?category=의류">의류</a>
		<a href="${ctx}/product/category?category=잡화">잡화</a>
		<a href="${ctx}/product/category?category=가구">가구</a>
		<a href="${ctx}/product/category?category=전자기기">전자기기</a>
		<a href="${ctx}/product/category?category=도서">도서</a>
		<a href="${ctx}/product/category?category=기타">기타</a>
	</nav>
