...
//		model.addAttribute("sellerNickName", loginNickname);
	...
	public String registerProduct(@RequestParam("productName") String name,
	        ...
	        @RequestParam(value = "description", required = false) String description, @RequestParam(value="imgFiles", required=false) List<MultipartFile> imgFiles, HttpSession session) {
//		if (session.getAttribute("loginMemberNo") == null) {
//			return "redirect:/login";
//		}
...
//		}
	...
	public String submitUpdateProduct(@PathVariable("productNo") int productNo, @ModelAttribute("product") Product product, @RequestParam(value = "imgFiles", required = false) List<MultipartFile> imgFiles, HttpSession session) {
//		if (session.getAttribute("loginMemberNo") == null) {
//			return "redirect:/login";
//		}
//		int loginMemberNo =(int) session.getAttribute("loginMemberNo");
